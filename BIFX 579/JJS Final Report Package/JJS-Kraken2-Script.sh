...
# Downloads the standard reference database
# --standard specifies database type
# --db is where the files go
...
# Sets a confidence interval to reduce false positive.
# --confidence specifies the threshold
...
# --classified-out indicates how the output files will be named, followed by the input files
# --db is where the reference database is located
# &> will generate a special error file for this specific command if something goes wrong
